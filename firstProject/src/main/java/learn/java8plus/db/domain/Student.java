package learn.java8plus.db.domain;
...
public class Student {
    ...
    public Student(String name, int gradeLevel, double gpa, String gender, int noteBooks, Optional<Bike> bike, List<String> activities) {
        this.name = name;
